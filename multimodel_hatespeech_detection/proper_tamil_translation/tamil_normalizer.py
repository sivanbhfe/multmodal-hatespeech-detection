# import sys
# sys.path.append(r"D:\AI_Doctorate\HateSpeechModel_Draft\MultimodelHateSpeechDetection_related\open-tamil")
# from solthiruthi import solthiruthi
...
empty_tamil_dict="D:\\AI_Doctorate\\HateSpeechModel_Draft\\MultimodelHateSpeechDetection_related\\tamil\\empty_tamil_words.txt"
sym_spell.load_dictionary(empty_tamil_dict, term_index=0, count_index=1)

def transliterate_to_tamil(text: str) -> str:
    """
    Convert Romanized Tamil (English letters) into Tamil script.
    Example: "naan varen" -> "நான் வரேன்"
    """
    try:
...
def correct_tamil_spelling(sentence: str) -> str:
    """
    Run Tamil spell checker to correct misspelled Tamil words.
    """
